...
public final class FragmentFeaturePhotograyBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFeaturePhotograyBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textView14, @NonNull TextView textView2, @NonNull TextView textView6,
  ...
  @NonNull
  public static FragmentFeaturePhotograyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFeaturePhotograyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_feature_photogray, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFeaturePhotograyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFeaturePhotograyBinding((ConstraintLayout) rootView, horizontalScrollView,
          imageView10, imageView11, imageView12, imageView14, imageView9, textView10, textView11,
          textView12, textView13, textView14, textView2, textView6, textView7, textView8,
          textView9);
    }
