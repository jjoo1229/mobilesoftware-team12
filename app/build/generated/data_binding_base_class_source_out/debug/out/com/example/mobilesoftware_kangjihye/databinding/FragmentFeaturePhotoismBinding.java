...
public final class FragmentFeaturePhotoismBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFeaturePhotoismBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView20, @NonNull ImageView imageView21, @NonNull ImageView imageView9,
  ...
  @NonNull
  public static FragmentFeaturePhotoismBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFeaturePhotoismBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_feature_photoism, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFeaturePhotoismBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFeaturePhotoismBinding((ConstraintLayout) rootView, horizontalScrollView,
          imageView10, imageView11, imageView12, imageView13, imageView14, imageView17, imageView19,
          imageView20, imageView21, imageView9, textView10, textView11, textView12, textView13,
          textView14, textView3, textView6, textView7, textView8, textView9);
    }
