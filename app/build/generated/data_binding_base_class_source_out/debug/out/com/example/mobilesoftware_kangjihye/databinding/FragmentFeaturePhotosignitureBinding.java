...
public final class FragmentFeaturePhotosignitureBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFeaturePhotosignitureBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentFeaturePhotosignitureBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFeaturePhotosignitureBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_feature_photosigniture, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFeaturePhotosignitureBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFeaturePhotosignitureBinding((ConstraintLayout) rootView,
          horizontalScrollView, imageView10, imageView11, imageView12, imageView13, imageView14,
          imageView9, textView10, textView11, textView12, textView13, textView14, textView6,
